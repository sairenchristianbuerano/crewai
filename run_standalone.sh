#!/bin/bash
# CrewAI Services - Standalone Run Script
# Starts both component-index and component-generator services

set -e

echo "=============================================="
echo "CrewAI Services - Standalone Mode"
echo "=============================================="
echo ""
...
export TOOLS_DIR=./data/crewai_components
...
for i in {1..30}; do
    if curl -s http://localhost:$PORT_INDEX/api/crewai/component-index/health > /dev/null 2>&1; then
...
export RAG_SERVICE_URL=$COMPONENT_RAG_URL
...
for i in {1..30}; do
    if curl -s http://localhost:$PORT_GENERATOR/api/crewai/component-generator/health > /dev/null 2>&1; then
...
echo "  Component Index:     http://localhost:$PORT_INDEX/docs"
echo "  Component Generator: http://localhost:$PORT_GENERATOR/docs"
echo ""
echo "Logs:"
